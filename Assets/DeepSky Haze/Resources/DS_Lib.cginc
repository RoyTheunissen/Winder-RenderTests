...
uniform sampler2D _DS_FogAmbientLightGradient;
...
inline void ComposeAtmosphere(inout fixed3 sceneColour, DSHazeData data)
{
	...
	sceneColour = lerp(sceneColour + data.rayleigh + _DS_LightColour * data.mie, ac + _DS_FogDirectLight * data.fogR, data.fogE);
}
