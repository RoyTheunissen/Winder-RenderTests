...
namespace DeepSky.Haze
{
    ...
    {
        public enum Multiplier { OneTenth, OneFifth, OneHalf, One, Two, Five, Ten, OneHundredth };
        ...
        public float m_FogStartHeight = 0.0f;
        [SerializeField]
        public Color m_FogAmbientColour = Color.white;
        [SerializeField]
        public Color m_FogLightColour = Color.white;
        [SerializeField] public Texture2D m_FogAmbientGradient;
        #endregion
        ...
        public void Lerp(DS_HazeContextItem other, float dt)
        {
            ...
            m_FogStartHeight = m_FogStartHeight * dTinv + other.m_FogStartHeight * dt;
