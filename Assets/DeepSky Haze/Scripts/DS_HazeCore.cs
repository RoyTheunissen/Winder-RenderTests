...
namespace DeepSky.Haze
{
    ...
    public class DS_HazeCore : MonoBehaviour
    {
        ...
        private bool IsMainHazeController
        {
        ...
        void Awake()
        {
            ...
            else if (!IsMainHazeController)
            {
                // ROY: You want to load multiple scenes at once sometimes and in this case the
                // other haze cores shouldn't suddenly be disabled.
