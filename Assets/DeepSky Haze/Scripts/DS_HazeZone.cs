using RoyTheunissen.Winder.Gameplay;
using UnityEngine;

namespace DeepSky.Haze
{
    [ExecuteInEditMode, AddComponentMenu("DeepSky Haze/Zone", 52)]
    public class DS_HazeZone : MonoBehaviour, IParentedToMainService
    {
        #region FIELDS
        [SerializeField]
        ...
        public void ParentToMainInstance()
        {
            // Reparent ourselves to the main core otherwise we don't work at all! This needs to
            // be dynamic because scenes are loaded dynamically.
            transform.parent = DS_HazeCore.Instance.transform;
        }
